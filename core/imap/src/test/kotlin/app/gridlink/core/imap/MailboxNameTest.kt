...
class MailboxNameTest {
     ...
     * name is a bare `&` (an invalid encoding — Gridlink up to 1.4.3 could create one, since it
     ...
     * Gridlink itself created such folders up to 1.4.3, which is why [select] carries a retry for
