 ...
 * finishes the job. In between, the message is still returned by every FETCH. Sterna reaches that
 ...
 * which is how a Thunderbird user's Trash looks to Sterna today.
 *
