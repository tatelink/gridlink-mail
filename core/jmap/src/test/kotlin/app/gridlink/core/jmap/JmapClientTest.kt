...
class JmapClientTest {
    ...
    @Test fun sendEmail_returnsTheCreatedEmailId() = runBlocking {
        ...
        val emailId = client.sendEmail(
            ...
            auth = BasicAuth("u", "p"),
            identityId = "i1",
            from = app.gridlink.core.jmap.model.EmailAddress(name = "Jordan", email = "jordan@example.org"),
            to = listOf(app.gridlink.core.jmap.model.EmailAddress(email = "dest@example.org")),
            subject = "Hi",
            textBody = "Hello",
