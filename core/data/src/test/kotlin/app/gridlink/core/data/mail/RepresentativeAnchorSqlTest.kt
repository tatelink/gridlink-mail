 ...
 * [app.gridlink.core.data.db.EmailDao.oldestRepresentativeEmailId] (and its companion count,
 * [app.gridlink.core.data.db.EmailDao.representativeCountForMailbox]): the fetch-older page is
