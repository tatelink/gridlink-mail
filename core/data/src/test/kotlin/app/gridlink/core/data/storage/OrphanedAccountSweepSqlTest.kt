...
import app.gridlink.core.data.mail.DaoQuerySource
...
class OrphanedAccountSweepSqlTest {
    ...
    @Test fun `both callers hand the sweep a reader of the account store`() {
        val callers = mapOf(
            "app/src/main/kotlin/app/gridlink/GridlinkApplication.kt" to "accountStore",
            "app/src/main/kotlin/app/gridlink/ui/settings/AccountsViewModel.kt" to "store",
        )
    ...
    private object SweepShape {
        ...
        private val SOURCE: String by lazy {
            locate("core/data/src/main/kotlin/app/gridlink/core/data/storage/StorageRepository.kt").readText()
        }
