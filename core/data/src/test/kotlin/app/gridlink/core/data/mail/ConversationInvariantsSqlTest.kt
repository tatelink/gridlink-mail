 ...
 * ([app.gridlink.core.data.db.EmailDao.cachedThreadEmails]), the flat list ([pagingSql]) and the
 * drawer badges ([app.gridlink.core.data.db.EmailDao.observeThreadUnreadCounts] /
 * [app.gridlink.core.data.db.EmailDao.observeMessageUnreadCounts]). Each case here runs TWO shipped
