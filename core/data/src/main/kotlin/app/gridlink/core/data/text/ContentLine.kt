...
data class ContentLine(
     ...
     *
     * 🔴 Deliberately does NOT split on commas. `CN=Locklear, Dana` is malformed but real, and a
     * splitting reader turns that organiser into "Locklear". Callers that genuinely have a
