...
/**
 * SOURCE LINT, NOT A BEHAVIOUR TEST — same instrument as [app.gridlink.ui.NavHostSourceRulesTest],
...
class ConversationScopeWiringTest {
    ...
    companion object {
        ...
        private const val INBOX_VIEW_MODEL_PATH = "$APP_SOURCES/app/gridlink/ui/inbox/InboxViewModel.kt"
        private const val INBOX_SCREEN_PATH = "$APP_SOURCES/app/gridlink/ui/inbox/InboxScreen.kt"
        private const val CONVERSATION_EXPANSION_PATH = "$APP_SOURCES/app/gridlink/ui/inbox/ConversationExpansion.kt"
        private const val REPOSITORY_PATH = "core/data/src/main/kotlin/app/gridlink/core/data/mail/MailRepository.kt"
