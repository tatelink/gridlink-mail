...
import app.jmail.JmailApplication
...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_MARK_READ = "app.jmail.action.MARK_READ"
        const val ACTION_DELETE = "app.jmail.action.DELETE"
        const val ACTION_REPLY = "app.jmail.action.REPLY"
