...
data class GridlinkColors(
     ...
     * across every Gridlink surface, and at the same time the aurora BACKDROP is a thing Brandon
...
object GridlinkDimens {
     ...
     *
     * ⚠️ §9 lists "no FAB" as an anti-requirement and Brandon overrode it directly. Sized to match
...
object GridlinkMotion {
     ...
     * what Brandon reported as sticking. 1200 puts it at roughly 190ms, which is quick enough to
