 ...
 * Upstream Gridlink's own DESIGN.md specifies Material You dynamic colour, hierarchy from space
...
data class GridlinkColors(
     ...
     * It was the warm secondary accent, and it is warm in exactly one mode now. Tate, 2026-08-10:
     ...
     * Tate: "the action button needs to be a different color." It used to share [accent] with
...
val GridlinkDayColors = GridlinkColors(
    ...
    // 🔴 Blue in Day by Tate's call, and DEEPER than [accent] on purpose: a button the same blue
...
val GridlinkOledColors = GridlinkColors(
    ...
    // 🔴 The one mode that is still warm, and the softer orange Tate asked for: same lightness as
