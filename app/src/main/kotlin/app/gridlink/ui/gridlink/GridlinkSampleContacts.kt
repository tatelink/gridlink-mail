...
object GridlinkSampleContacts {
     ...
     * the names). 🔴 The FORM does not: Brandon's rule is that Last name and Company are separate
    ...
    data class GridlinkContact(
         ...
         *
         * Given before company for the person with no surname: "Cher" who works at Duke Energy is
    ...
    val all: List<GridlinkContact> = listOf(
        ...
        // visible on the emulator without a live account. Brandon asked for a stock photo for the
        // demonstration, so the photo is a face — an AI-generated one (this-person-does-not-exist),
        // NOT a photograph of a real person pretending to be Marisol. The company rides alongside
        ...
        GridlinkContact(
            ...
            addresses = listOf("11220 Elm Ln, Suite 240, Charlotte, NC 28277, USA"),
