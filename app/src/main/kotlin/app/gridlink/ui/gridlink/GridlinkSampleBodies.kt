...
internal object GridlinkSampleBodies {
    ...
    private val bodies: Map<String, String> = mapOf(
        ...
        "fill-duke" to (
            "<p><img src=\"https://www.duke-energy.com/-/media/images/email/masthead.png\" " +
                "alt=\"Duke Energy\" width=\"480\"></p>" +
                ...
                "<img src=\"https://track.duke-energy.com/o.gif?m=2210447\" width=\"1\" height=\"1\">"
            ),
        "fill-rgarza" to (
        ...
        // -------------------------------------------------------------------------------------
        "draft-sysco-credit" to (
            "<p>Hi Ray,</p>" +
                "<p>The Tuesday truck landed 3 cases short at 0449 BELMONT again, same as the " +
        ...
        "draft-cap-456" to (
            "<p>Corrective Action Plan, Store 456, inspection 07/24.</p>" +
        ...
        // Brandon's actual correspondents.
        // -------------------------------------------------------------------------------------
        "sent-duke-meter" to (
            "<p>Attaching the meter photo for 0449 BELMONT taken this morning, reading 41,208.</p>" +
        ...
        "sent-alta-recap" to (
            "<p>Weekly recap for all five stores is attached.</p>" +
                "<p>456 and Pineville are both ahead of plan. Belmont is the one to watch: labour " +
                "is fine but waste is up for the third week and it is all on the fried side.</p>" +
                "<p>I am at Belmont Thursday and will send a note after.</p>"
            ),
    )
}
