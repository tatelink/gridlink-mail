 ...
 * `EmailEntity` is keyed by the PAIR `(accountId, id)` rather than by the id. Two of Tate's
...
object GridlinkMailMapping {
     ...
     * existed, which the folder's next refresh fills in. Saying nothing beats saying "Tate".
     *
