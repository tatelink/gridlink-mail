...
object GridlinkSampleTree {
        ...
        GridlinkFolder(
            ...
            children = listOf(
                GridlinkFolder(
                    ...
                    name = "Ops",
                    children = listOf(
                        GridlinkFolder(id = "ops-456", name = "Store 456"),
                        GridlinkFolder(id = "ops-belmont", name = "0449 Belmont"),
                        GridlinkFolder(id = "ops-pineville", name = "0120 Pineville"),
                        GridlinkFolder(id = "ops-midtown", name = "0797 Midtown"),
                ...
                GridlinkFolder(
                    ...
                    name = "Vendors",
                    children = listOf(
                        GridlinkFolder(id = "vendor-ecolab", name = "Ecolab"),
     ...
     *
     * ⚠️ Own mail only, not a rolled-up total including children. Ops reading 2 while Store 456 under
