 ...
 *
 * ⚠️ There was a Write item here that composed to the counterparty. It is gone by Brandon's call
    ...
    GridlinkDetailFrame(
        ...
        bottom = {
            GridlinkDetailActionPill(modifier = Modifier.weight(1f)) {
                ...
                // 🔴 Edit lives in the pill, not the accent circle. Brandon, 2026-08-10: "the edit
