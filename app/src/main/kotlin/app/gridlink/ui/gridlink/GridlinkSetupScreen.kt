 ...
 * Brandon's brief was that step one is server, credentials, and the sync choice, in that order and in
 ...
 * missing — which is exactly how Brandon read it.
 */
@Composable
fun GridlinkSetupScreen(
    ...
    GridlinkFormScreen(
        ...
        GridlinkFormTextRow(
            ...
            // keystroke into "Brandon@…", and the local part of an address is case sensitive.
            capitalization = KeyboardCapitalization.None,
