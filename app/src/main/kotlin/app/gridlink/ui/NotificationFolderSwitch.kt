...
object NotificationFolderSwitch {
     ...
     *    ([app.gridlink.ui.inbox.selectionIsGone]); switching INTO one would undo that. An EMPTY
     *    folder list means "not known yet", not "the folder is gone" — the caller must not treat
     *    that as a verdict, and [app.gridlink.ui.inbox.InboxViewModel] waits for a loaded list
     *    instead of asking;
