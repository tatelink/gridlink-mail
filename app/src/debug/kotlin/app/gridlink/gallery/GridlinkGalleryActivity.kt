...
class GridlinkGalleryActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //   am start -S -n .../GridlinkGalleryActivity --es open jeff-dogs
        //   am start -S -n .../GridlinkGalleryActivity --es open alta-belmont --ef openAt 0.45
        ...
        //   am start -S -n .../GridlinkGalleryActivity --es tab folders --es mailbox ops-456
        //
        ...
        //   am start -S -n .../GridlinkGalleryActivity --es open jeff-dogs --es signed mismatch
        //   am start -S -n .../GridlinkGalleryActivity --es open jeff-dogs --es invite conflicts
        ...
        require(signedName == null || openId != null) {
            "signed='$signedName' rides on an open message, so it needs one. Add --es open jeff-dogs."
        }
        ...
        require(inviteName == null || openId != null) {
            "invite='$inviteName' rides on an open message, so it needs one. Add --es open jeff-dogs."
        }
        ...
        require(openIds.isNotEmpty() || openAt == 1f) {
            "openAt=$openAt without --es open, --es contact, --es event or --es mailbox would hold " +
                "nothing part-way. Add --es open jeff-dogs."
        }
