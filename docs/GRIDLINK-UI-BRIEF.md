...
┌──────────────────────────────────────────────────┐
│▌ Altametrics                            7:14 AM  │
│▌ Daily Sales Summary 0449 BELMONT 07/30      📎  │
└──────────────────────────────────────────────────┘
```
...
┌──────────────────────────────────────────────────┐
│▌ Reports                            14 new    ⌄  │
│▌ Altametrics, Power BI, Steritech                │
└──────────────────────────────────────────────────┘
```
...
| Sender | Subject | Time |
|---|---|---|
| Altametrics | Daily Sales Summary 0449 BELMONT 07/30 | 7:14 AM |
| Power BI Service | Refresh failed: Area51_P7_Rollup (dataset) | 6:52 AM |
| Steritech | ACTION REQUIRED: Corrective Action Plan due 08/04 Store 456 | 6:31 AM |
| Jeff | did you feed the dogs | 6:22 AM |
| Bojangles HR | Open Enrollment closes Friday, action needed for all salaried TMs | Yesterday |
| Altametrics | Labor Variance Exception Report 0459 RANDOLPH RD Week 30 | Yesterday |
| M. Rivera | Callout Saturday AM, need coverage 120 Pineville | Yesterday |
| Inspire Brands Talent | Franchise Business Consultant, next steps and availability | Tue |
| Steritech | Pest Sighting Report filed 0797 MIDTOWN | Tue |
| Power BI Service | Your subscription: Area 51 Weekly Scorecard | Mon |
