...
**Short version: Gridlink collects nothing. It talks only to the mail server you
configure, and everything else stays on your device.**

Gridlink is free software (GPLv3) with no business model built on your data. There
is no Gridlink account, no Gridlink server, and no company in the middle. This document
explains exactly what that means, in plain terms. Last updated: 2026-06-21.

## What Gridlink does NOT do
...
- **No Google services.** Gridlink does **not** use Firebase, Google Play Services,
  ...
  de-Googled devices.
- **No proprietary dependencies.** Gridlink is built only from free/open-source
  libraries.

## Data stored on your device

Everything Gridlink keeps lives locally on your phone and is never uploaded anywhere
...
Gridlink makes network connections to **one place only: the JMAP mail server you
...
Gridlink cannot make your email provider private. Whatever server you connect to
necessarily processes your messages and sees your requests — that is true of any
email client. If this matters to you, connect Gridlink to a server you trust or one
you run yourself (for example, a self-hosted [Stalwart](https://stalw.art/)
instance). Choosing and trusting your provider is the one privacy decision Gridlink
leaves in your hands.

## Permissions and why they are needed

Gridlink requests the minimum set of permissions:
...
Beyond these, Gridlink asks for no other permissions — no location, no storage
